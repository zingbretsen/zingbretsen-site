...
/usr/share/doc/fzf/examples/plugin/fzf.vim`}</Output>
</CodeExample>
...
<CodeExample language="bash" prompt="$">
  <Input>dpkg -S /usr/share/zsh/vendor-completions/_rg</Input>
  <Output>ripgrep: /usr/share/zsh/vendor-completions/_rg</Output>
</CodeExample>
...
<CodeExample language="bash" prompt="$">
  <Input>dpkg -S vendor-completions | sort | head -n 4</Input>
  <Output>{`curl: /usr/share/zsh/vendor-completions/_curl
docker-ce-cli: /usr/share/zsh/vendor-completions/_docker
docker-compose: /usr/share/zsh/vendor-completions/_docker-compose
flatpak: /usr/share/zsh/vendor-completions/_flatpak`}</Output>
</CodeExample>
